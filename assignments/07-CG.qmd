...
1) Identify any prior assignments you would like regraded (this week only). 2) Identify CG motifs in 10 of your sequences and visulize in IGV.
:::

# Amnesty

This week you can turn in all missing assignments to be assessed at [here](https://github.com/course-fish546-2023/assistance-public/issues/15)
...
push these files to GitHub. Grab raw urls to visualize in IGV. Fasta file is "genome". Take 2 screenshots and place in code file. 
