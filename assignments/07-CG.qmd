...
This week you can turn in all missing assignments to be assessed [here](https://github.com/course-fish546-2023/assistance-public/issues/15)

# CG Motifs

For this you will take 10 sequences related to your project, ID CG motifs you emboss package: `fuzznuc`, and visualize in IGV. You do not have to follow this workflow exactly, but provided here for guidance. This uses R package `seqinr`.
...
Push these files to GitHub. Grab raw urls to visualize in IGV. Fasta file is "genome". Take 2 screenshots and place in code file. At the top of your code page be sure to provide link to visual report (rpubs). Alternatively you can also output to markdown. 
