...
3.  Read: [Introduction to the Command Line for Genomics](https://datacarpentry.org/shell-genomics/)\
...
6.  Request account on Roberts Lab Rstudio server using [the repo Issues](https://github.com/course-fish546-2023/assistance/issues).
